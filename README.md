...
==========================
[Generate new builds - Declarative Gradle](https://declarative.gradle.org/docs/reference/build-init/)
- `gradle init -Dorg.gradle.buildinit.specs=org.gradle.experimental.android-ecosystem-init:0.1.40`
  - https://github.com/gradle/declarative-gradle/blob/main/early-prototypes/android/build-logic/logic/src/main/kotlin/org/gradle/api/experimental/AndroidPlugin.kt
